...
[Keyless]
[Table("SAD_CUSTOMER_MASTER")]
public partial class SadCustomerMaster
{
    [Column("CUST_ID")]
    ...
    [Column("CUST_DEPMETHOD")]
    public int? CustDepmethod { get; set; }

    [Column("CUST_Amount_Type")]
    public int? CustAmountType { get; set; }

    [Column("CUST_RoundOff")]
    public int? CustRoundOff { get; set; }

    [Column("CUST_fontstyleid")]
    public int? CustFontstyleid { get; set; }

    [Column("CUST_rptBorder")]
    public int? CustRptBorder { get; set; }

    [Column("Cust_DeptID")]
    public int? CustDeptId { get; set; }

    [Column("Cust_DurtnId")]
    public int? CustDurtnId { get; set; }
}
