...
namespace TracePca.Interface.Master
{
    public interface ContentManagementMasterInterface
    {
        ...
        Task<(bool Success, string Message, List<AuditTypeChecklistMasterDTO> Data)> GetAuditTypeChecklistByStatusAsync(string status, int compId);
        ...
        Task<(bool Success, string Message, List<AuditCompletionSubPointMasterDTO> Data)> GetAuditSubPointsByStatusAsync(string status, int compId);
