...
namespace TracePca.Interface.FIN_Statement
{
    public interface JournalEntryInterface
    {
        ...
        Task<PaginatedResult<JournalEntryInformationDto>> GetJournalEntryInformationAsync(
        ...
        //SaveGeneralLedger
        Task<object> SaveGeneralLedgerAsync(int CompId, List<GeneralLedgerDto> dtos);
        //ActivateJE
        ...
        Task<PaginatedResponse<JETypeDropDownDetailsDto>> GetJETypeDropDownDetailsAsync(JETypeDropdownRequestDto request);
        //SaveJEType
